...
public class dbhavsa2_lab06_q1 {
	static class ConsoleInput {
		...
		public static char getValidatedChar(char minChar, char maxChar) {
			...
			do {
				try {
					System.out.print("Please input a character between " + minChar + " and " + maxChar + " inclusive: ");
